...
@Component({
  selector: 'app-content-home-wrapper',
  templateUrl: './content-home-wrapper.component.html',
  styleUrls: ['./content-home-wrapper.component.css']
})
export class ContentHomeWrapperComponent implements OnInit {
  postList = [
    { 
